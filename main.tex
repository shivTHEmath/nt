...
\\\\
Now if 1:1 tutoring were possible, a minimum of $.709\sigma$ growth would be visible after at most a year; in Bloom's study, a $2\sigma$ increase took only $3$ weeks \cite{bloom1984sigma}. Assuming a token spend of $\$1$ per hour, and that the tool is used $365$ hours a year, this would mean a spend of $\$365$ per student. Over the $50$ million students in the United States, this comes out to around $\$18$ billion, which is significantly less than the $\$500$ billion spent on natural growth. Moreover, 1:1 tutoring is significantly faster, and allows students to reach a higher level in their education.
