...
\[m(h) = (1-\xi_4)^{\left \lfloor h \right \rfloor} < 1.\] We use the floor function here because we do not want the access delay period and hint specificity to change constantly; we want the user to get comfortable with the current settings before we make them more challenging. Then the hint specificity after $h$ hours is given by
