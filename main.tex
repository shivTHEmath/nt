...
\begin{quote}
    At what combination of the parameters \textit{Answer Specificity, Access Delay, Metacognitive Prompting Rate}, \textit{Scaffolding Fade Rate} does an AI tutoring system provide sufficient support and engagement for the learner and improve performance, while enhancing their independent reasoning skills?
\end{quote}
...
\begin{table}[h]
    ...
    \midrule
        \text{Answer Specificity}   & $x_1$ & $\xi_1$ \\
    \midrule
